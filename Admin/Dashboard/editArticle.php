...
include '../modules/conn.php';
   ...
   if($_POST){
    ...
    $conn = OpenCon();
    $sql = "UPDATE `Articles` SET `Title`='$articleTitle', `Article`='$articleData', `District`='$articleDistrict', `Category`='$articleCategory', `Date`='".date("Y-m-d")."', `Status`='$articleStatus', `ImgListSize`='$noImgs', `ImgCap1`='$ImgCap1', `ImgCap2`='$ImgCap2', `ImgCap3`='$ImgCap3', `ImgCap4`='$ImgCap4', `ImgCap5`='$ImgCap5', `YoutubeId`='$youtubeId', `WriterId`='".$_SESSION["memberId"]."'
    WHERE `Id`= '$articleId'";
